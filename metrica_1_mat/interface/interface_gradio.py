...
# Ajustado para carregar todos os arquivos no diretório 'documentos'
...
qdrant_vector_store = Qdrant.from_documents(
    ...
    location=":memory:",
    collection_name="contexto_pedagogico"
)
...
def create_prompt_from_rag(query: str, vector_store: Qdrant, k_results: int = 5) -> str:
    ...
    return f"""
Você é um avaliador pedagógico. Responda com base apenas no contexto fornecido abaixo.
...
# --- 5. Configuração e Lançamento da Interface Gradio ---
if __name__ == "__main__":
    ...
    demo = gr.Interface(
        ...
        title="Chatbot Pedagógico (RAG + Gemini API)",
        description=(
            "Este chatbot oferece feedback pedagógico em Matemática, "
            "baseado em critérios definidos em documentos de contexto."
        ),
